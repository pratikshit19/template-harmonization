/**
 * ai-engine.js
 * Google Gemini API wrapper for all AI calls
 * Aligned with Sirion CLM Template Harmonization SOP
 */

const AIEngine = (() => {
  const GEMINI_BASE = 'https://generativelanguage.googleapis.com/v1beta/models';
  // FIX 1: Use the correct production model string (no "-latest")
  const DEFAULT_MODEL = 'gemini-2.5-flash';

  // FIX 2: Explicitly include 'gemini-1.5-flash-latest' to match the actual crash vector
  ...
  /* ── PHASE 2: GROUP SECTIONS ACROSS DOCUMENTS ──────── */
